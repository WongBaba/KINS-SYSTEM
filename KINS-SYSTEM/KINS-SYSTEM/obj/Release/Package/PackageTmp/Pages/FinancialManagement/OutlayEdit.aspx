<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutlayEdit.aspx.cs" Inherits="KINS_SYSTEM.Pages.FinancialManagement.OutlayEdit" %>
...
<head runat="server">
    ...
    <script>
        $(function () {
            ...
            $("#yes").click(function () {
                ef.success = function (ef) {$("#yes").attr("disabled", "true"); outlayEdit(jQuery.parseJSON(getUrlParam('data')).Ol_id); }
                ef.submit(false);
            });
        });

        function outlayEdit(id) {
            var data = new Object();
        ...
        function initPageData(data) {
            ...
            $("#Ol_payMethod").val(data.Ol_payMethod.replace(/ /g, ""));
...
<body>
    <div id="form1" style="width: 500px; height: 530px; background-color: white; border: 1px solid #ccc; margin: 0 auto; -moz-box-shadow: 0px 0px 10px #000;">
        <div class="containerTitle">编辑出账信息</div>
