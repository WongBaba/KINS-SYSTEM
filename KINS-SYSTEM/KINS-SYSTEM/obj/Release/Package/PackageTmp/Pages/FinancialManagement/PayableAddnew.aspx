<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayableAddnew.aspx.cs" Inherits="KINS_SYSTEM.Pages.FinancialManagement.PayableAddnew" %>
...
<link href="../../CSS/commPage.css" rel="stylesheet" />
    ...
    <script>
        ...
        function addNew() {
            ...
            data.Ol_state = "待出账";
            $.post("PayableAddnew.ashx", { data: JSON.stringify(data) },
               function (data) {
...
<body>
    <div id="form1" style="width: 500px; height: 530px; background-color: white; border: 1px solid #ccc; margin: 0 auto; -moz-box-shadow: 0px 0px 10px #000;">
        <div class="containerTitle">新增待出账信息</div>
        <div class="container">
            <ul>
                <li>
