<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnJob.aspx.cs" Inherits="KINS_SYSTEM.Pages.StaffManagement.OnJob" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        function onJob() {
            ...
            $.post("OnJob.ashx", { data: JSON.stringify(data) },
               function (data) {
