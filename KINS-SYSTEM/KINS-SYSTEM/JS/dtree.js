...
function dTree(objName) {
	...
	this.icon = {
		root				: '../../Image/Icon/base.gif',
		folder			: '../../Image/Icon/folder.gif',
		folderOpen	: '../../Image/Icon/folderopen.gif',
		node				: '../../Image/Icon/page.gif',
		empty				: '../../Image/Icon/empty.gif',
		line				: '../../Image/Icon/line.gif',
		join				: '../../Image/Icon/join.gif',
		joinBottom	: '../../Image/Icon/joinbottom.gif',
		plus				: '../../Image/Icon/plus.gif',
		plusBottom	: '../../Image/Icon/plusbottom.gif',
		minus				: '../../Image/Icon/minus.gif',
		minusBottom	: '../../Image/Icon/minusbottom.gif',
		nlPlus			: '../../Image/Icon/nolines_plus.gif',
		nlMinus			: '../../Image/Icon/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
