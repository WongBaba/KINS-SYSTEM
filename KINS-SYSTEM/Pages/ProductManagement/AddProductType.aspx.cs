    ...
    public partial class AddProductType : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (Session["permissions"].ToString().IndexOf("#P03") < 0)
                {
                    Response.Redirect("~/Pages/NoPermission.aspx?permissionId=#P03");
                }
            }
        }
        ...
        {
            string sqlStr = "SELECT * FROM k_ProductType WHERE Tp_name='" + PdTp.Text + "'";
            DbSql ds = new DbSql();
            ...
            sqlStr = "INSERT INTO k_ProductType (Tp_name, Tp_type,Tp_company) VALUES ('" + PdTp.Text + "', '成品','"+Session["company"]+"')";
