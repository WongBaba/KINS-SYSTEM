<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddComponentType.aspx.cs" Inherits="KINS_SYSTEM.Pages.ProductManagement.AddComponentType" %>
...
<body>
    <form id="form1" runat="server">
        <div style="width: 400px; height: 175px; background-color: white; border: 1px solid #ccc; margin: 0 auto; -moz-box-shadow: 0px 0px 10px #000;">
            <div class="containerTitle">添加新零件类型</div>
            <div class="container">

                <asp:TextBox ID="ComTp" runat="server"></asp:TextBox>
