<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddComponent.aspx.cs" Inherits="KINS_SYSTEM.Pages.ProductManagement.AddComponent" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        function addCompany() {
            ...
            $.post("addComponent.ashx", { data: JSON.stringify(data) },
                function (data) {
                    if (data == "2") {
                        closeFrame();
                    } else if (data == "0") {
...
<body>
    <div  id="form1" style="width: 500px; height: 530px; background-color: white; border: 1px solid #ccc; margin: 0 auto; -moz-box-shadow: 0px 0px 10px #000;">
        <div class="containerTitle">添加零件</div>
        <div class="container">
            <ul>
                <li>
                ...
                <li>
                    <div class="name name non-null">零件规格</div>
                    <div class="value">
                        <input id="Cp_parameter" type="text" data-easyform="length:1 140;char-chinese;" data-message="规格不能为空，限140字" data-easytip="disappear:none;class:KINS;disappear:other;" />
                    </div>
                </li>
                <li>
                    <div class="name">零件价格</div>
                    <div class="value">
                        <input id="Cp_price" type="text" data-easyform="null;float:10 3" data-message="价格格式错误（x.xxx）" data-easytip="disappear:none;class:KINS;disappear:other;" />
                    </div>
                </li>
                <li>
