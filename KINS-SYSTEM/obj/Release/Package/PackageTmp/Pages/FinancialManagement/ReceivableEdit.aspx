<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceivableEdit.aspx.cs" Inherits="KINS_SYSTEM.Pages.FinancialManagement.IncomeEdit" %>
...
<body>
    <div id="form1" style="width: 500px; height: 530px; background-color: white; border: 1px solid #ccc; margin: 0 auto; -moz-box-shadow: 0px 0px 10px #000;">
        <div class="containerTitle">编辑待进账信息</div>
