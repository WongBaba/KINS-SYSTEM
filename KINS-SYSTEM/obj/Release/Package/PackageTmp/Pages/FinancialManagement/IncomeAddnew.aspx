<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncomeAddnew.aspx.cs" Inherits="KINS_SYSTEM.Pages.FinancialManagement.IncomeAddnew" %>
...
<link href="../../CSS/commPage.css" rel="stylesheet" />
    ...
    <script>
        ...
        function addNew() {
            ...
            data.Ic_state = "进账";
            $.post("IncomeAddnew.ashx", { data: JSON.stringify(data) },
               function (data) {
...
<body>
    <div id="form1" style="width: 500px; height: 530px; background-color: white; border: 1px solid #ccc; margin: 0 auto; -moz-box-shadow: 0px 0px 10px #000;">
        <div class="containerTitle">新增进账</div>
        <div class="container">
            <ul>
                <li>
                    <div class="name non-null">收款时间</div>
                    <div class="value">
