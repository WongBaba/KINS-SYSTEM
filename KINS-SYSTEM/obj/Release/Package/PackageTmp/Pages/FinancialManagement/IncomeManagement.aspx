<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncomeManagement.aspx.cs" Inherits="KINS_SYSTEM.Pages.FinancialManagement.Income" %>
...
<head runat="server">
    ...
    <script>
        ...
        function incomeAddnew() {
            showBlackScreen();
            $(".blackFrame").attr("src", "IncomeAddnew.aspx");
        }
        ...
        function incomeDelete() {
            ...
            showBlackScreen();
            $(".blackFrame").attr("src", "incomeDelete.aspx?Ic_id=" + safeUrlValue(data));
        }
        ...
        function setPageData() {
            ...
            for (var i = (parseInt($("#pageNum").val()) - 1) * parseInt($(".tablePage select").val()) + 1 - starCom ; i < maxi ; i++) {
                ...
                tb += "<td>" + pageData[i].Ic_payMethod + "</td>";
                tb += "<td title='" + pageData[i].Ic_content + "'>" + pageData[i].Ic_content + "</td>";
                tb += "<td>" + pageData[i].Ic_operator + "</td>";
                tb += "<td>" + toDateTime(pageData[i].Ic_editDate) + "</td>";
                tb += "<td title='" + pageData[i].Ic_remarks + "'>" + pageData[i].Ic_remarks + "</td>";
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="List">
            <span class="containerTitle">进账信息<a id="Ic_addNew">&nbsp;+ 新增&nbsp;&nbsp;</a><a id="Ic_delete">&nbsp;- 删除&nbsp;&nbsp;</a><a id="export">&nbsp; 导出为Excel&nbsp;&nbsp;</a></span>
            <table class="comTable">
                <thead>
                    <tr>
                        ...
                        <th style="width: 10%">收款方式</th>
                        <th style="width: 10%">收款内容</th>
